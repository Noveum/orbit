...
export const SEED_ISSUES: readonly SeedIssue[] = [
  ...
  },
  {
    ...
    description:
      'When an organization allow lists `orbit.example`, anyone signing in with that domain joins as a member without an invite.',
    state: 'Todo',
    priority: 3,
    assignee: null,
    labels: ['Feature'],
...
export const SEED_DOCS: readonly SeedDoc[] = [
  {
    ...
    author: 'sam',
    repoBinding: { repo: 'example/orbit-demo', path: 'docs/realtime.md', branch: 'main' },
    content:
