    ...
    <section className="flex flex-col gap-5">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted text-xs">
          Connect GitHub and Slack. Orbit verifies every webhook, links pull requests to issues, and
          keeps both sides in sync in realtime.
        </p>
      </div>
      <IntegrationsPanel settings={settings} canManage={can(principal, 'integration:manage')} />
    </section>
  );
}
